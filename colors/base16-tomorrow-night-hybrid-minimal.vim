...
if !has("gui_running")
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-tomorrow-night-hybrid.sh"
  endif
endif
...
if has("nvim")
  ...
  let g:terminal_color_4 =  "#7092ae"
  let g:terminal_color_5 =  "#967890"
  let g:terminal_color_6 =  "#6f9e98"
  let g:terminal_color_7 =  "#707880"
  let g:terminal_color_8 =  "#595d63"
  ...
  let g:terminal_color_background = "#1d1d1d"
...
hi clear
syntax reset
let g:colors_name = "base16-tomorrow-night-hybrid-minimal"
...
call <sid>hi("Error",         s:gui08, s:gui00, s:cterm08, s:cterm00, "", "")
...
call <sid>hi("Macro",         s:gui04, "", s:cterm04, "", "", "")
call <sid>hi("MatchParen",    s:gui0A, s:gui00, s:cterm0A, s:cterm00,  "", "")
...
call <sid>hi("Define",       s:gui04, "", s:cterm04, "", "none", "")
call <sid>hi("Delimiter",    s:gui04, "", s:cterm04, "", "", "")
...
call <sid>hi("PreProc",      s:gui04, "", s:cterm04, "", "", "")
